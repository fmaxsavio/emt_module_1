...
const backMusic = new Audio('https://raw.github.com/fmaxsavio/EMTGamifiedMCQ-CO1/main/BGM.mp3');
const backgroundMusic = new Audio('https://raw.github.com/fmaxsavio/EMTGamifiedMCQ-CO1/main/snake-rattle-sound-hq-240150.mp3');
const answerRight = new Audio('https://raw.github.com/fmaxsavio/EMTGamifiedMCQ-CO1/main/RightAnswer.mp3');
const answerWrong = new Audio('https://raw.github.com/fmaxsavio/EMTGamifiedMCQ-CO1/main/WorngAnswer.mp3');
canvas.width = 900;
canvas.height = 400;
let snake = [{ x: 10, y: 10 }];
let snakeLength = 1;
